<form  method="post" class='form_<?php echo $source; ?>' accept-charset="utf-8" action="<?php echo $edit_action;?>">
  ...
  <div class="form-group">
     ...
     <input class="form-control" id='babi' name="<?php echo $name[1];?>" placeholder="Judul Profile" type="text" value="<?php echo $berita->berita_title?>">
  </div>
  <div class="form-group">
     <label>Isi Berita</label>
     <?php echo $this->ckeditor->editor($name[2],"form-control","$berita->berita_content"); ?>
  </div>
  <div class="form-group">
