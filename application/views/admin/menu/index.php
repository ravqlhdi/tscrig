                                ...
                                <td style="text-align:center">
                                  <div class="dropdown">
                                      ...
                                      <ul class="dropdown-menu pull-right">
                                          <li><a href="<?php echo site_url('submenu?id='.$value->menu_id)?>" class=" waves-effect waves-block">Sub Menu</a></li>
                                          <li><a href="<?php echo site_url($current_page.'/edit?id='.$value->menu_id)?>" class=" waves-effect waves-block">Edit</a></li>
                                          <li><a href="javascript:void(0);" onclick="changeDeleteUrl(<?php echo $value->menu_id.',\''.$value->menu_name.'\'';?>)" class=" waves-effect waves-block" data-toggle="modal" data-target="#deleteModal">Delete</a></li>
                                      </ul>
                                  </div>
                                </td>
                              </tr>
